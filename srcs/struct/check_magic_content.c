...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/04/28 17:50:42 by kboddez           #+#    #+#             */
/*   Updated: 2017/04/28 17:50:42 by kboddez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_magic_content_bis(t_env *e, int i)
{
	if (is_redirection(e, i) && manage_check_red(e, i) == -1)
		...
		return (token_error(e, i + 1));
			...
			&& (!is_special_aggre(e, i) || is_invalid_spe_aggre(e, i)))
	{
